defmodule Lesson01 do
  ...
  defmodule State, do: defstruct ~w(parent config canvas timer)a
  ...
  # int InitGL(GLvoid)
  def setup_gl(win) do
    {_w, _h} = :wxWindow.getClientSize win # oddly, you need to do this or resizing doesn't happen. period.
